...
const services = [
  {
    ...
    icon: Zap,
    description: "Páginas web de alto rendimiento optimizadas para SEO y conversión en España y Panamá.",
    features: [
  ...
  },
  {
    ...
    icon: TrendingUp,
    description: "Tiendas online diseñadas para vender. Optimizamos cada paso del proceso de compra.",
    features: [
  ...
  },
  {
    ...
    icon: CheckCircle2,
    description: "Desarrollo de apps nativas y multiplataforma con la última tecnología del mercado.",
    features: [
      "Apps iOS y Android",
